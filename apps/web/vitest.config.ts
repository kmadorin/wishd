...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@wishd/plugin-sdk/svm/react": path.resolve(__dirname, "../../packages/plugin-sdk/src/svm/react.ts"),
      "@wishd/plugin-sdk/svm/testing": path.resolve(__dirname, "../../packages/plugin-sdk/src/svm/testing.ts"),
      "@wishd/plugin-sdk/client/emit": path.resolve(__dirname, "../../packages/plugin-sdk/src/client/emit.ts"),
